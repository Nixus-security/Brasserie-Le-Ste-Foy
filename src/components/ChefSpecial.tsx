        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-[1px] mt-[1px] bg-white/5">
          {[
            ...
            <Reveal key={stat.label} animation="fade-up" delay={200 + i * 150} duration={700}>
              <div className="bg-navy-dark p-6 sm:p-8 text-center group hover:bg-navy-dark/80 transition-colors">
                {stat.icon === "tripadvisor" && (
                  <svg className="w-5 h-5 mx-auto mb-3 text-[#34E0A1] group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                ...
                {stat.icon === "google" && (
                  <svg className="w-5 h-5 mx-auto mb-3 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
